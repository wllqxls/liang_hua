...
|---|---|---:|---|---|---:|---:|---:|---:|---:|---:|---|
| ETH/USDT | 5m | 2025 | OFF | FAIL_SLICE | -0.86 | 2 | -3.36 | -3.97 | 0.55 | 57 | 平均窗口收益不为正; 全年收益不为正; Profit Factor 低于 1.05; cost-after Profit Factor is below 1.15; fewer than 8 of 12 independent windows are positive |
